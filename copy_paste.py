...
class CopyPaste(A.DualTransform):
    ...
    def __init__(self, binary_class, p_, data_root = "../input/data", json_dir = "./splited_json/train_split_0.json", p = 0.5, always_apply = False):
        ...
        value = self.category_names.index(self.binary_class)

        self.indexes = self.train_df.query("category_id == @value").index
